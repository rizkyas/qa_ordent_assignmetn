...
WebUI.setText(findTestObject('TC-A1-001/Page_Bioskop Online/input__email'), 'afsyussalaam@')

WebUI.waitForElementPresent(findTestObject('TC-A1-001/Page_Bioskop Online/div_Email harus mengandung'), 0)
