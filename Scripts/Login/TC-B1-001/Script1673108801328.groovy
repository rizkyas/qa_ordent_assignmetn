...
WebUI.setText(findTestObject('Login/input_Atau_username'), 'rizkyafsyussalaam18@gmail.com')
...
WebUI.waitForElementPresent(findTestObject('Login/div_Verifikasi         Email Kamu belum terverifikasi      ri18gmail.com       Lakukan verifikasi email untuk bisa masuk ke akun bioskop online      Verifikasi'), 
    0)
